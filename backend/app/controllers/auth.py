...
from app.services.auth import authenticate_user, create_session_token, get_user_from_token
...
def serialize_user(user: User) -> UserResponse:
    return UserResponse(id=user.id, username=user.username, is_superuser=user.is_superuser)
